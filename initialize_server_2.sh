...
#bash -c 'azcopy copy "https://tempsoftshare01.blob.core.windows.net/steamaccount2fafiles/maFiles/*" "/opt/steamguard-files/" || true'
fi
...
#Change mapname, TODO update replacements to target parameters in config regardless of current value
